...
jqGridExport:function(d){d=a.extend({exptype:"xmlstring",
...
"<"+d.root+">"+xmlJsonClass.json2xml(f,d.ident)+"</"+d.root+">";break;case "jsonstring":e="{"+xmlJsonClass.toJson(f,d.root,d.ident,!1)+"}",void 0!==f.postData.filters&&(e=e.replace(/filters":"/,'filters":'),e=e.replace(/}]}"/,"}]}"))}}});return e},
excelExport:function(d){d=a.extend({exptype:"remote",url:null,oper:"oper",tag:"excel",exportOptions:{}},d||{});return this.each(function(){if(this.grid){var e;"remote"===d.exptype&&(e=a.extend({},this.p.postData),e[d.oper]=d.tag,e=jQuery.param(e),e=-1!==
